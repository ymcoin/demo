...
def test_SdA(finetune_lr=0.1, pretraining_epochs=1,
             ...
             batch_size=10, h=[10, 10], cl=[.1, .2], cost_vec=[1, 1.2], beta=30,logger=None):
...
def run_experiment():
    ...
    experiment_list.append(
        {'finetune_lr': 0.01, 'pretraining_epochs': 0, 'pretrain_lr': 0.001, 'training_epochs': 1, 'batch_size': 1,
         'h': [5], 'cl': [.1, .1], 'cost_vec': [1, 4], 'beta': 10})
    experiment_list.append(
        {'finetune_lr': 0.01, 'pretraining_epochs': 0, 'pretrain_lr': 0.001, 'training_epochs': 1, 'batch_size': 1,
         'h': [5], 'cl': [.1, .1], 'cost_vec': [1, 4], 'beta': 10})
    experiment_list.append(
    ...
    experiment_list.append(
        {'finetune_lr': 0.01, 'pretraining_epochs': 0, 'pretrain_lr': 0.001, 'training_epochs': 1, 'batch_size': 1,
         'h': [5], 'cl': [.1, .1], 'cost_vec': [1, 4], 'beta': 10})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 4], 'beta': 10})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 3.5], 'beta': 10})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 3], 'beta': 10})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 2.5], 'beta': 10})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 2], 'beta': 10})
    #
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 4], 'beta': 15})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 3.5], 'beta': 15})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 3], 'beta': 15})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 2.5], 'beta': 15})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 2], 'beta': 15})
    #
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 4.8], 'beta': 20})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 5], 'beta': 20})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 5.3], 'beta': 20})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 5.6], 'beta': 20})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 5.8], 'beta': 20})
    #
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 4.8], 'beta': 25})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 5], 'beta': 25})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 5.3], 'beta': 25})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 5.6], 'beta': 25})
    # experiment_list.append(
    #     {'finetune_lr': 0.01, 'pretraining_epochs': 10, 'pretrain_lr': 0.001, 'training_epochs': 60, 'batch_size': 1,
    #      'h': [60], 'cl': [.1, .1], 'cost_vec': [1, 5.8], 'beta': 25})

    # params_dictionary = {'finetune_lr': 0.01, 'pretraining_epochs': 0, 'pretrain_lr': 0.001, 'training_epochs': 1,
    #                      'batch_size': 1, 'h': [5], 'cl':[.1,.1],'cost_vec': [1, 4.5], 'beta': 1}
    # experiment_list.append((params_dictionary))
    result = [run_helper(ex) for ex in experiment_list]
...
def run_experiment_parallel():
    ...
    experiment_list.append(
        {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 6.1], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 10,
         'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.005})
    experiment_list.append(
        {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 6.2], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 10,
         'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.005})
    experiment_list.append(
        {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 6.3], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 10,
         'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.005})
    experiment_list.append(
        {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 6.1], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 20,
         'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.005})
    experiment_list.append(
        {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 6.2], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 20,
         'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.005})
    experiment_list.append(
        {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 6.3], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 20,
         'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.005})
    experiment_list.append(
        {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 6.1], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 30,
         'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.005})
    experiment_list.append(
        {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 6.2], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 30,
         'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.005})
    experiment_list.append(
        {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 6.3], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 30,
         'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.005})
    # experiment_list.append(
    #     {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 3], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 1,
    #      'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.01})
    # experiment_list.append(
    #     {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 4], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 1,
    #      'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.01})
    # experiment_list.append(
    #     {'cl': [0.1, 0.1], 'h': [60], 'cost_vec': [1, 5], 'batch_size': 1, 'pretrain_lr': 0.001, 'beta': 1,
    #      'pretraining_epochs': 0, 'training_epochs': 60, 'finetune_lr': 0.01})
